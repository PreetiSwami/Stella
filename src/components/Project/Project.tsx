      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Custom Website tailored to your business needs with cutting-edge technologies.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <footer> <ul className="tech-list"> <li>Netsparker</li> <li>SonarQube</li> <li>Grabber</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Custom Mobile App Development-iOS,Android.We design and develop user-friendly,high-preformance apps that align with your goals.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
